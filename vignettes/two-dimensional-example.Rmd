...
```{r windowsize}
catsim(basemat, shiftmat,weights=rep(.2,5), window = 20)
catsim(basemat, shiftmat,weights=rep(.2,5), window = 5)
catsim(basemat, errmat,weights=rep(.2,5), window = 20)
catsim(basemat, errmat,weights=rep(.2,5), window = 5)
