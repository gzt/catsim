...
in an image. It attempts to assess similarity between two images that accounts for the 
structural features of the image rather than a per-pixel discrepancy, ideally in
